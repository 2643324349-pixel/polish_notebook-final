...
// GoogleIcon and Sign in with Google are temporarily disabled for Creem review.
// Re-enable when Google OAuth is configured in Supabase + Google Cloud Console.
...
export function LoginPage() {
  ...
  const { user, loading, isSubmitting, login, register, resetPassword } =
    useAuth();
